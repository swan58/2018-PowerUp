...
namespace components {
  class Drive {
    ...
    private:
      ...
      const double turnTolerance = 2.0, driveTolerance = 40; // Tolerance variables
      const double kSG = (80.0*(50.0/12.0)*(60.0/24.0)*(60.0/24.0))/(6.0*PIE*0.0254);  //(80*26.041666667)/0.4787787204 ~= 4351.35
      const double kFG = (80.0*(50.0/12.0)*(34.0/50.0)*(60.0/24.0))/(6.0*PIE*0.0254);
